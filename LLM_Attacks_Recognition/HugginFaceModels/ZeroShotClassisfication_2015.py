...
with open('/media/work/icarovasconcelos/LLM_Attacks_Recognition/HugginFaceModels/' + foldName + '__' + str(sample_size*2) + 'Samples' + '.txt', 'w') as file:
...
# Save the figure
figName = foldName + '__' + str(sample_size*2) + 'Samples' + '-ZeroShot_Comparison.png'
