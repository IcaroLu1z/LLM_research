...
tokenizer = AutoTokenizer.from_pretrained(
    ...
    truncation=True,
    padding=True,
    max_length=42, #Necessario para o llama
    )
...
_, foldName = model_id.split(sep='/')
with open('/media/work/icarovasconcelos/LLM_Attacks_Recognition/HugginFaceModels/' + 'QA' + foldName + '__' + str(sample_size*2) + 'Samples' + '.txt', 'w') as file:
...
# Save the figure
figName = 'QA' + foldName + '__' + str(sample_size*2) + 'Samples' + '-ZeroShot_Comparison.png'
plt.savefig('/media/work/icarovasconcelos/LLM_Attacks_Recognition/HugginFaceModels/' + figName)
